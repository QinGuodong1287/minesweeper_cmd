...
class AboutGame(graphics.Window):
    def __init__(self, parent):
        ...
        ncurses_version = "{major}.{minor}-{patch}".format(major=curses.ncurses_version.major, minor=curses.ncurses_version.minor, patch=curses.ncurses_version.patch)
        self.text_lines = """\
关于 扫雷
作者：Qin Guodong <qinguodong07@qq.com>
版本 {version}
curses 版本：{curses_version}
ncurses 库版本：{ncurses_version}""".format(version=__version__, curses_version=curses_version, ncurses_version=ncurses_version).splitlines()
    ...
    def eventloop(self):
        ...
        self.win.addstr(0, 0, "关于", curses.A_NORMAL)
        ...
        self.win.addstr(terminal_size.lines - 1, 0, "按“q”键退出该页面。", curses.A_NORMAL)
